...
const Navbar = () => {
  ...
  const navItem = (path, label) => (
    <Link
      to={path}
      className={`relative px-6 md:px-6 py-2 md:py-4 text-sm md:text-lg font-semibold transition-all duration-300
  ...
  return (
    <div className="sticky top-0 z-50 backdrop-blur-xl bg-[#020617]/95 border-b border-white/10">
      <div className="max-w-[1600px] mx-auto px-4 md:px-14 py-6 md:py-6 flex items-center justify-between flex-wrap">

        {/* LEFT SIDE : LOGO */}
        <div className="hidden md:flex items-center gap-5 cursor-pointer" onClick={() => navigate("/")}>
          <div className="w-10 h-10 md:w-14 md:h-14 rounded-2xl bg-gradient-to-br from-green-400 to-blue-500 flex items-center justify-center font-bold text-black text-2xl">
            K
          </div>
          <h1 className="text-xl md:text-4xl font-bold tracking-wide bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent">
            KodeBase
          </h1>
        </div>
