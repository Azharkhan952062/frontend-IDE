...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 backdrop-blur-xl bg-[#020617]/95 border-b border-white/10">
      <div className="max-w-[1600px] mx-auto px-14 py-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-5 cursor-pointer" onClick={() => navigate("/")}>
          ...
          <h1 className="text-4xl font-bold tracking-wide bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent">
            KodeBase
          </h1>
        </div>
