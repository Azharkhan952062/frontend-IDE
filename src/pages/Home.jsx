  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#020617] via-[#020617] to-[#0f172a] text-white">
      ...
      <div className="flex items-center justify-between px-20 pt-8">
        <h3 className="text-4xl md:text-5xl font-extrabold leading-tight bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 text-transparent bg-clip-text drop-shadow-[0_0_25px_rgba(168,85,247,0.5)] animate-[pulse_4s_ease-in-out_infinite]">Ready to build something amazing today? 🚀</h3>
        <button onClick={() => setIsCreateModelShow(true)}
          className="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-blue-500 hover:scale-105 transition-all shadow-lg shadow-indigo-500/30">
          + Create Project
        </button>
      </div>

      {/* PROJECT GRID */}
      <div className="px-20 mt-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
